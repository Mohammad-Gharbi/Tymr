...
export function Navigation() {
  const sessionTime = useRef<HTMLInputElement>(null)
              ...
              <div>
                ...
                <div className="flex flex-row items-center ">
                  <div className="mr-4 flex flex-col justify-start">
                    ...
                    <input
                      onChange={() =>
                        dispatch(
                          editTimer({
                            session: sessionTime.current?.value,
                            break: breakTime.current?.value,
                          })
                        )
                      }
                      ref={sessionTime}
                      className="h-8 w-24 rounded-md bg-[#cccccc] text-black"
                      type="number"
                      min="1"
                      step="1"
                    ></input>
                  ...
                  <div className="flex flex-col justify-start">
                    <div className="text-black">Break</div>
                    <input
                      onChange={() =>
                        dispatch(
                          editTimer({
